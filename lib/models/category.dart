...
class Feed {
  ...
  Feed({this.xmlLang, this.xmlns, this.xmlnsDcterms, this.xmlnsThr, this.xmlnsApp, this.xmlnsOpensearch, this.xmlnsOpds, this.xmlnsXsi, this.xmlnsOdl, this.xmlnsSchema, this.id, this.title, this.updated, this.icon, this.author, this.link, this.opensearchTotalResults, this.opensearchItemsPerPage, this.opensearchStartIndex, this.entry});
  ...
  Feed.fromJson(Map<String, dynamic> json) {
    ...
    opensearchTotalResults = json[r'opensearch$totalResults'] != null ? new Id.fromJson(json[r'opensearch$totalResults']) : null;
    opensearchItemsPerPage = json[r'opensearch$itemsPerPage'] != null ? new Id.fromJson(json[r'opensearch$itemsPerPage']) : null;
    opensearchStartIndex = json[r'opensearch$startIndex'] != null ? new Id.fromJson(json[r'opensearch$startIndex']) : null;
    if (json['entry'] != null) {
...
class Link {
  ...
  Link({this.rel, this.type, this.href, this.title, this.opdsActiveFacet, this.opdsFacetGroup, this.thrCount});
...
class Entry {
  ...
  Entry({this.title, this.id, this.author, this.published, this.updated, this.dctermsLanguage, this.dctermsPublisher, this.dctermsIssued, this.summary, this.category, this.link, this.schemaSeries});
  ...
  Entry.fromJson(Map<String, dynamic> json) {
    ...
    published = json['published'] != null ? new Id.fromJson(json['published']) : null;
    updated = json['updated'] != null ? new Id.fromJson(json['updated']) : null;
    dctermsLanguage = json[r'dcterms$language'] != null ? new Id.fromJson(json[r'dcterms$language']) : null;
    dctermsPublisher = json[r'dcterms$publisher'] != null ? new Id.fromJson(json[r'dcterms$publisher']) : null;
    dctermsIssued = json[r'dcterms$issued'] != null ? new Id.fromJson(json[r'dcterms$issued']) : null;
    ...
    schemaSeries = json[r'schema$Series'] != null ? new SchemaSeries.fromJson(json[r'schema$Series']) : null;
  }
